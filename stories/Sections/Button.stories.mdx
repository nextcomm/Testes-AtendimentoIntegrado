  ...
  <Story name="colors">
    {{
      template: `<div class="row">
          ...
          <div class="margin-horizontal-2">
              <woot-button color-scheme="primary">Success</woot-button> 
          </div>
          <div class="margin-horizontal-2">
  ...
  <Story name="variants">
    {{
      template: `<div class="row">
          ...
          <div class="margin-horizontal-2">
              <woot-button color-scheme="primary" variant="clear">Success</woot-button> 
          </div>
          <div class="margin-horizontal-2">
...
<Canvas>
  <Story name="icononly">
    {{
      template: `<div class="row">
          <div class="margin-horizontal-2">
              <woot-button color-scheme="primary" icon="ion-plus" size="tiny"></woot-button> 
          </div>
          <div class="margin-horizontal-2">
